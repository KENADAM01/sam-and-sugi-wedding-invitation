...
const Hero = () => {
    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-rapunzel-50 to-rapunzel-100">
            ...
            {/* Flynn - Bottom Left */}
            <div className={`absolute bottom-0 -left-8 md:left-0 z-10 w-48 md:w-96 lg:w-[500px] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 -translate-x-10 translate-y-10'}`}>
                <img
                    src={flynnImg}
                    alt="Flynn Rider"
